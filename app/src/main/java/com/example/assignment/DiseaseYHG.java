...
public class DiseaseYHG extends AppCompatActivity {
...
private Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray Array = jsonObjectSS.getJSONArray("Mumps_virus");//배열의 이름
            JSONObject ObjectAG = Array.getJSONObject(0);
            ...
            stringBuilder.append("이름 : ").append(region).append(" 나이 : ").append(latitude).append(" 주소 : ").append(latitude).append("\n");
            ...
            stringBuilder4.append("[").append(name).append(" 정의]").append(def);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.editmenu:
                Intent intented = new Intent(DiseaseYHG.this, AddActivity.class);
                startActivity(intented);
                return true;
            case R.id.deletemenu:
                Toast.makeText(this, "삭제되었습니다.", Toast.LENGTH_SHORT).show();
                YHList.yhnum--;
                YHList.mydata[0] = null;
